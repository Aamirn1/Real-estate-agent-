          ...
          <Reveal>
            <div className="rounded-3xl border border-[#94A3B8] bg-white p-7 shadow-[0_30px_80px_-20px_rgba(30,41,59,0.12)] sm:p-10">
              ...
              <div className="mb-8 border-b border-[#E2E8F0] pb-6">
                ...
                <h2 className="mt-4 font-heading text-2xl font-semibold text-[#1E293B] sm:text-3xl">
              ...
              <div className="flex flex-col gap-6">
                {sections.map((s, i) => (
                  <section key={i}>
                    ...
                    <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-[#1E293B]/70">
                      {s.body}
                    </p>
                  </section>
                ))}
...
function Fact({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 text-center">
      <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[#1E293B]/45">
        {label}
      </p>
      <p className="mt-1 font-heading text-lg font-semibold text-[#1E293B]">
        {value}
      </p>
    </div>
  );
