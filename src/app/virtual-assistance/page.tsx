...
const VA_PLANS: VAPlan[] = [
  {
    ...
    price: "$599",
    period: "Per Month",
    tagline: "Dedicated VA support to get started",
    cta: "Get Started",
    ctaVariant: "outline",
    features: [
      { text: "Dedicated Virtual Assistant", included: true },
      { text: "Up to 10 Hours/Month", included: true },
      { text: "Basic Admin & Email Support", included: true },
      { text: "Task Updates via Email", included: true },
      { text: "2 Revisions per Task", included: true },
      { text: "Social Media Help", included: false },
      { text: "Daily Task Reporting", included: false },
      { text: "Priority Response", included: false },
      { text: "CRM Tasks", included: false },
      { text: "Real-Time Chat Access", included: false },
