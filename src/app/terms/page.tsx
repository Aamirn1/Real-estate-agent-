...
export const metadata: Metadata = {
  title: "Terms & Conditions — Opus Solutions",
  description:
    "The terms governing your use of Opus Solutions' marketing consulting, outreach, and CRM services for real estate professionals.",
};
...
const SECTIONS: TermSection[] = [
  {
    ...
    body: "By engaging Opus Solutions or using any of our services, you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, you should not engage our services.",
  },
  {
    heading: "2. Description of Services",
    body: "Opus Solutions provides marketing consulting and support services for licensed real estate professionals. Our services include:",
    bullets: [
  ...
  },
  {
    ...
    body: "Opus Solutions is not a real estate brokerage. We do not list or sell property, and we do not resell leads. We act solely as a marketing consulting and support partner to licensed real estate professionals.",
  },
  {
  ...
  },
  {
    ...
    body: "All materials, workflows, documentation, and methodologies developed by Opus Solutions remain our intellectual property. Clients receive a limited license to use these materials for the duration of the engagement and for the purposes of the contracted services.",
  },
  {
    heading: "10. Limitation of Liability",
    body: "Opus Solutions does not guarantee specific business results, lead conversions, or revenue outcomes. Our service improves efficiency through marketing support, documentation, and workflow management. We are not liable for indirect, incidental, or consequential damages arising from the use of our services.",
  },
  {
    heading: "11. Governing Law",
    body: "These Terms & Conditions are governed by the laws of the United States. Any disputes shall be resolved per applicable state law in the jurisdiction where Opus Solutions operates.",
  },
  {
    heading: "12. Contact",
  ...
  return (
    <SiteChrome>
      <PageHero
        ...
        description="The terms governing your use of Opus Solutions' services."
      />
