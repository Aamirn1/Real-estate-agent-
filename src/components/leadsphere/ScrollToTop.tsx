    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="group fixed bottom-5 left-5 z-[65] flex h-12 w-12 items-center justify-center rounded-full border border-electric/30 bg-[#f8f9fa]/90 text-black shadow-[0_10px_30px_-8px_rgba(0,0,0,0.7),0_0_20px_-2px_rgba(37,99,235,0.5)] backdrop-blur-xl transition-all hover:border-electric/60 hover:bg-[#f1f3f5] hover:shadow-[0_0_24px_-6px_rgba(37,99,235,0.7),0_0_30px_-2px_rgba(56,189,248,0.6)] sm:bottom-6 sm:left-6"
        >
