...
// Official Opus Global Solution social profiles — verified handle @opusglobalsolution.
// These are crawlable <a href> links (rendered in the footer markup below).
// Do NOT replace with JavaScript click handlers or buttons without href.
function TikTokIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43V8.45a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.05z" />
    </svg>
  );
}
...
const SOCIALS: { Icon: typeof Facebook; label: string; href: string }[] = [
  {
    Icon: Facebook,
    label: "Opus Global Solution on Facebook",
    href: "https://www.facebook.com/opusglobalsolution",
  },
  {
    Icon: Instagram,
    label: "Opus Global Solution on Instagram",
    href: "https://www.instagram.com/opusglobalsolution",
  },
  {
    Icon: TikTokIcon,
    label: "Opus Global Solution on TikTok",
    href: "https://www.tiktok.com/@opusglobalsolution",
  },
  {
    Icon: Youtube,
    label: "Opus Global Solution on YouTube",
    href: "https://www.youtube.com/@opusglobalsolution",
  },
];
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-2 lg:gap-8">
        ...
        <Reveal delay={0.2} className="h-full">
          <div className="flex h-full flex-col gap-4">
            ...
            {/* Connect With Us — crawlable social profile links */}
            <div className="rounded-2xl border border-black/15 bg-black/5 p-5">
              ...
              <p className="mt-1.5 text-sm leading-relaxed text-black">
                Follow us for real estate growth insights, lead generation
                strategies, and marketing support updates.
              </p>
              <div className="mt-3 flex flex-wrap items-center gap-3">
                <a
                  ...
                  aria-label="Opus Global Solution on Facebook"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(120deg,#2563EB,#38BDF8,#14B8A6,#2563EB)] animate-gradient-x bg-[length:200%_200%] text-white shadow-[0_4px_12px_-2px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_-2px_rgba(56,189,248,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric/50"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Opus Global Solution on Instagram"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(120deg,#2563EB,#38BDF8,#14B8A6,#2563EB)] animate-gradient-x bg-[length:200%_200%] text-white shadow-[0_4px_12px_-2px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_-2px_rgba(56,189,248,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric/50"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Opus Global Solution on TikTok"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(120deg,#2563EB,#38BDF8,#14B8A6,#2563EB)] animate-gradient-x bg-[length:200%_200%] text-white shadow-[0_4px_12px_-2px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_-2px_rgba(56,189,248,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric/50"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Opus Global Solution on YouTube"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[linear-gradient(120deg,#2563EB,#38BDF8,#14B8A6,#2563EB)] animate-gradient-x bg-[length:200%_200%] text-white shadow-[0_4px_12px_-2px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_-2px_rgba(56,189,248,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric/50"
                >
