            ...
            <div className="rounded-2xl border border-black/15 bg-black/5 p-5">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-black/15 bg-white text-black transition-all hover:-translate-y-0.5 hover:border-electric/40 hover:bg-electric/10 hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric/50"
                >
