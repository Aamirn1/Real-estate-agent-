    ...
    <div className="relative flex h-[300px] w-full items-center justify-center">
      ...
      >
        ...
        >
          ...
          {/* Center sparkle */}
          <Sparkles className="relative h-7 w-7 text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]" />
        </div>
        ...
        <div className="grid w-full grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
          {AI_FEATURES.map((f, i) => (
            <Reveal key={f.label} delay={i * 0.05} className="h-full">
              <GlassCard
                sheen
                className="group flex h-full items-center gap-3 p-3 transition-all duration-300 hover:border-white/20 hover:shadow-[0_0_34px_-10px_rgba(59,130,246,0.55)] sm:p-4"
              >
...
function StepNumber({ n }: { n: number }) {
  return (
    <div className="relative flex h-14 w-14 items-center justify-center">
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-electric via-violet to-cyan font-heading text-lg font-semibold text-white shadow-[0_0_30px_-6px_rgba(139,92,246,0.75)]">
        {n}
      </span>
    </div>
  );
        ...
        <Reveal y={36}>
          ...
          >
            <div className="flex flex-col md:flex-row">
              {/* ---------- Sidebar ---------- */}
              <aside className="flex w-full shrink-0 flex-col gap-4 border-b border-white/10 p-4 md:w-60 md:border-b-0 md:border-r">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-white/10 bg-white/5 py-2 pl-8 pr-3 text-xs text-white/80 outline-none transition placeholder:text-white/35 focus:border-electric/50 focus:bg-white/8"
                  />
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={[
                          ...
                          isActive
                            ? "bg-gradient-to-r from-electric/25 to-violet/20 text-white shadow-[0_0_24px_-10px_rgba(59,130,246,0.7)] ring-1 ring-inset ring-white/15"
                ...
                <div className="mt-auto hidden border-t border-white/8 pt-3 md:block">
              ...
              <div className="relative h-[440px] flex-1 overflow-hidden sm:h-[540px]">
                          ...
                          {isHovered && (
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="mt-0.5 pl-3 text-[10px] text-white/55">
                                  Est. value{" "}
                                  <span className="tnum font-medium text-white/80">
                                    {p.value}
                                  </span>{" "}
                                  · {PIN_LABELS[p.type]}
                                </div>
                ...
                <div className="absolute right-3 top-3 z-40 sm:right-4 sm:top-4">
                  <GlassCard strong className="px-3 py-2.5">
                    <div className="mb-1.5 text-[10px] font-medium uppercase tracking-wider text-white/45">
                      Pin legend
                    </div>
                    <div className="flex flex-col gap-1.5">
