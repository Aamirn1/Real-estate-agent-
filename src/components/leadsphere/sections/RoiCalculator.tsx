            ...
            <div className="relative">
              ...
              <div className="mt-5 rounded-2xl border border-electric/25 bg-gradient-to-br from-electric/10 to-violet/10 p-5">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-white/65">Return on investment</span>
                ...
                <div className="mt-2 font-heading text-3xl font-bold text-white tnum sm:text-4xl">
              ...
              <a
                href="#pricing"
                className="group mt-5 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-electric to-violet px-5 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_-6px_rgba(59,130,246,0.6)] transition-all hover:shadow-[0_0_32px_-4px_rgba(139,92,246,0.8)]"
              >
  ...
  return (
    <div className="mb-6">
      <div className="mb-2.5 flex items-center justify-between">
        ...
        <span className="font-heading text-base font-semibold text-white tnum">
          {format(value)}
        </span>
      </div>
      <input
...
function ResultCard({
  ...
  return (
    ...
    >
      ...
      <div className="font-heading text-xl font-bold text-white tnum sm:text-2xl">
