        ...
        <Reveal>
          <GlassCard strong className="p-6 sm:p-8">
            ...
            <div className="mt-6 flex items-center gap-2 rounded-xl border border-electric/20 bg-electric/5 p-3.5">
              ...
              <p className="text-xs leading-relaxed text-[#1E293B]/65">
            ...
            <div className="relative">
              <div className="mb-6 flex items-center gap-2.5">
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-electric to-violet">
                  <TrendingUp className="h-4.5 w-4.5 text-[#1E293B]" />
                </span>
                <h3 className="font-heading text-lg font-semibold text-[#1E293B]">
              ...
              <div className="mt-5 rounded-2xl border border-electric/25 bg-gradient-to-br from-electric/10 to-violet/10 p-5">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[#1E293B]/65">Return on investment</span>
                ...
                <div className="mt-2 font-heading text-3xl font-bold text-[#1E293B] tnum sm:text-4xl">
              ...
              <a
                href="#pricing"
                className="group mt-5 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-electric to-violet px-5 py-3.5 text-sm font-semibold text-[#1E293B] shadow-[0_0_24px_-6px_rgba(59,130,246,0.6)] transition-all hover:shadow-[0_0_32px_-4px_rgba(139,92,246,0.8)]"
              >
  ...
  return (
    <div className="mb-6">
      <div className="mb-2.5 flex items-center justify-between">
        <span className="flex items-center gap-2 text-sm text-[#1E293B]/70">
          <Icon className={`h-3.5 w-3.5 text-${color}`} />
          {label}
        </span>
        <span className="font-heading text-base font-semibold text-[#1E293B] tnum">
          {format(value)}
        </span>
      </div>
      <input
...
function ResultCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-xl border border-[#E2E8F0] bg-white/[0.03] p-4"
    >
      <div className="mb-2 flex items-center gap-1.5">
        <Icon className={`h-3.5 w-3.5 ${tint}`} />
        <span className="text-[11px] uppercase tracking-wide text-[#1E293B]/45">
          {label}
        </span>
      </div>
      <div className="font-heading text-xl font-bold text-[#1E293B] tnum sm:text-2xl">
