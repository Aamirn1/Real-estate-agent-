  ...
  if (submitted) {
    return (
      <GlassCard strong sheen className="relative w-full max-w-md overflow-hidden p-8">
        ...
        >
          <CheckCircle2 className="h-8 w-8 text-[#1E293B]" />
        </motion.div>
        ...
        <button
          ...
          className="relative mt-6 w-full rounded-xl border border-[#E2E8F0] bg-[#1E293B]/5 py-3 text-sm font-medium text-[#1E293B]/70 transition-colors hover:bg-[#1E293B]/8"
        >
          Back to form
        </button>
      </GlassCard>
    ...
    <GlassCard strong sheen className="relative w-full max-w-md overflow-hidden p-7 sm:p-8">
      ...
      <div className="relative">
        ...
        <div className="mb-5 grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-2 rounded-xl border border-[#E2E8F0] bg-[#1E293B]/5 py-2.5 text-sm font-medium text-[#1E293B]/75 transition-colors hover:bg-[#1E293B]/8">
        ...
        <div className="mb-5 flex items-center gap-3">
          <div className="h-px flex-1 bg-[#1E293B]/8" />
          <span className="text-xs text-[#1E293B]/35">or continue with email</span>
          <div className="h-px flex-1 bg-[#1E293B]/8" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <FormField
            ...
            trailing={
              <button
                ...
                className="text-[#1E293B]/40 transition-colors hover:text-[#1E293B]/70"
              >
          ...
          {!isSignup ? (
            <div className="flex items-center justify-between">
              <label className="flex cursor-pointer items-center gap-2 text-xs text-[#1E293B]/55">
                <input
                  type="checkbox"
                  checked={form.remember}
                  onChange={(e) => setForm({ ...form, remember: e.target.checked })}
                  className="h-3.5 w-3.5 rounded border-[#E2E8F0] bg-[#1E293B]/5 accent-electric"
                />
                Remember me
              </label>
            ...
            <label className="flex cursor-pointer items-start gap-2 text-xs text-[#1E293B]/55">
              <input
                type="checkbox"
                checked={form.agree}
                onChange={(e) => setForm({ ...form, agree: e.target.checked })}
                required
                className="mt-0.5 h-3.5 w-3.5 rounded border-[#E2E8F0] bg-[#1E293B]/5 accent-electric"
              />
              <span>
                I agree to the{" "}
        ...
        {/* Switch */}
        <p className="mt-6 text-center text-sm text-[#1E293B]/50">
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        required={required}
        className={cn(
          "w-full rounded-xl border border-[#E2E8F0] bg-[#1E293B]/5 py-3 pl-10 pr-10 text-sm text-[#1E293B] placeholder:text-[#1E293B]/35 transition-colors",
          "focus:border-electric/50 focus:bg-[#1E293B]/5 focus:outline-none focus:ring-1 focus:ring-electric/30"
        )}
      />
      {trailing && (
