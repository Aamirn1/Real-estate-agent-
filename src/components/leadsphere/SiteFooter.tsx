...
/* TikTok icon — lucide-react does not provide one, so a lightweight
   inline SVG is used. This keeps the icon set consistent (no extra
...
function LogoMark() {
  return (
    <Link href="/" className="group flex items-center transition-transform group-hover:scale-[1.02]">
      <LogoImage className="h-10 sm:h-11" />
    </Link>
  );
}
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <span className="text-xs font-semibold uppercase tracking-[0.12em] text-black/60">
                Connect With Us
              </span>
